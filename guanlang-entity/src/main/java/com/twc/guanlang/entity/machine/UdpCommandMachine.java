...
@Data
@Entity
@Table(name = "t_udpcomman_machine")
//@com.gitee.sunchenbin.mybatis.actable.annotation.Table(name = "t_udpcomman_machine")
public class UdpCommandMachine extends BaseEntity {
...
//    @com.gitee.sunchenbin.mybatis.actable.annotation.Column(name = "doorNumber", type = MySqlTypeConstant.VARCHAR)
